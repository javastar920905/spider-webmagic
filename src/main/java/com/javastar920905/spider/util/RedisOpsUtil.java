...
public class RedisOpsUtil {
  ...
  public static final byte[] KEY_58CITY_LIST_URLS = "spider:list:urls:58city".getBytes();
  ...
  /**
   * //获取前50条url List<byte[]> positionUrlList =
   * connection.lRange(RedisOpsUtil.KEY_JOB51_POSITION_LINK, 0, 49); List<String> urls
   * =RedisOpsUtil.getStringList(positionUrlList);
   *
   * @param collection
   * @return
   */
